...
**Observations**:
  ...
  - Price and carat are positively, though not perfectly, correlated
  - Carat often snaps to a whole number size, e.g. 1 carat, 2 carat
...
**Observations**:
  ...
  - The larger the carat, the more likely it is to have a “lower” cut
    grade
  - Ideal cuts appear to have higher prices per carat weight
